					...
					{event.totalTodoLeft > 0 ? (
						<>
							<Stack width={"100%"}>
								...
								>
									<Grid
										sx={{ border: "3px solid #7986CB", boxShadow: "0px 4px 26px 14px #232C43", borderRadius: "0.625rem", padding: "1.5rem 1.25rem", flexDirection: { xs: "column", md: "row" }, marginRight: { xs: 0, md: 4 } }}
										width={"100%"}
										justifyContent={"space-between"}
										container
									>
